            ...
            <div class="panel panel-default">
                <div class="panel-heading">User forum - create category</div>
                    <div class='createCat'>
                        ...
                        @endif
                        <?php
                        echo Form::open(array('action' => array('UserForumController@createCategory')));
                        echo Form::label('', 'name:'); ?> <br>  
                        <div class="col-xs-3"> <?php
                        echo Form::text('name',null, array('class'=>'form-control input-xs')); ?>
                        </div> <br><br> <?php
                        echo Form::label('', 'description:'); ?> <br> 
                        <div class=""><?php
                        echo Form::textarea('description',null, array('class'=>'form-control input-xs', 'rows'=>'3')); ?>
                        </div> <br> <?php
