                ...
                foreach($topics as $topic){
                      ...
                      ?>   
                        <tr id='topicRow<?php echo $topic->id ?>'>             
                            <td><a href="/forum/categories/<?php echo $cat->id;?>/<?php echo $topic->id; ?>"><?php echo $topic->subject; ?></a></td>  
                            <td><?php
                            ...
                            <?php
                                //delete
                                echo Form::open(array('action' => array('UserForumController@deleteTopic'),'id'=>'form-topicdelete' .$topic->id));
                        ...
                        $(function() {                           
                            $("#delete-btn<?php echo $topic->id?>").click(function(){                           
                                $.ajax({
                                    url: '/forum/categories/deleteTopic',
                                    type: "post",
